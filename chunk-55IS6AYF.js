import{ab as I,d as l,e as d,g as m,i as g,j as h,k as f,l as u,q as R,t as E}from"./chunk-54SA56SH.js";var y=(()=>{let i=class i{constructor(){this.http=E(I),this.MAX_RETRIES=50}getAllData(){return this.http.get("https://docs.google.com/spreadsheets/d/1yRrrjbgYoQRKOnXMzhAFIZUgCnulSp8XYKZg3EuG4q0/export?format=csv",{responseType:"text"}).pipe(l(t=>this.csvToJson(t)))}csvToJson(t){let e=t.split(`
